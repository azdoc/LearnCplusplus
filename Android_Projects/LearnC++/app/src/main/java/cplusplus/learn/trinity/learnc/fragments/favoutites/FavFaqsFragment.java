...
import cplusplus.learn.trinity.learnc.activites.FrequentQuestionsActivity;
...
public class FavFaqsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        frequentQuestionsRecyclerItemsAdapter = new FrequentQuestionsRecyclerItemsAdapter(getContext(), frequentQuestionsRecyclerItemsList,"FAQ");
    ...
    private void prepareRecyclerItems() {
        ...
        databaseAccess.open();
        arrayList = databaseAccess.getFavFAQ();
