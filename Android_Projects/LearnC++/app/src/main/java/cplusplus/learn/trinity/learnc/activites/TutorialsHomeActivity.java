...
public class TutorialsHomeActivity extends CommonActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ObjectFragment(), "object oriented");
        adapter.addFragment(new AdvanceFragment(), "advance");
